...
@Component(
        immediate = true,
        property = {
                "mvc.command.name=" + MVCCommandNames.PRODUCT_INVENTORY_DETAILS_RESOURCE,
                "javax.portlet.name=" + ReportPortletKeys.PRODUCT_INVENTORY_DETAILS_REPORT_PORTLET
        },
        service = MVCResourceCommand.class
)

public class ProductInventoryDetailsResource extends BaseMVCResourceCommand {
	private static final Log log = LogFactoryUtil.getLog(ProductInventoryDetailsResource.class);
