...
@Component(
		...
		property = { 
			...
			"javax.portlet.display-name=Product Inventory Details Report", 
			"javax.portlet.init-param.template-path=/",
			"javax.portlet.init-param.view-template=/product-inventory-details-report/view.jsp",
			"javax.portlet.name=" + ReportPortletKeys.PRODUCT_INVENTORY_DETAILS_REPORT_PORTLET,
...
public class ProductInventoryDetailsReportPortlet extends MVCPortlet{
private static Log log = LogFactoryUtil.getLog(ProductInventoryDetailsReportPortlet.class);
