 ...
 * The type Webcontent structure modify panel category.
 */
@Component(
	property = {
...
public class WebcontentStructureModifyPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return WebcontentStructureModifyPanelCategoryKeys.CONTROL_PANEL_CATEGORY;
	}
