...
import com.ntuc.notification.cron.logic.ClsFailedJobsCronJobRunner;
...
public class ClsFailedJobsCronScheduler implements MessageListener {

    private static final String JOB_NAME = "cls-failed-jobs-cron-job";
    private static final String GROUP_NAME = "cls-failed-jobs-cron-group";
    ...
    protected void activate() throws Exception {
        ...
        cronExpression = (String) paramValues.get(ParameterKeyEnum.CLS_FAILED_JOBS_CRON_EXPRESSION);
        ...
        runner = new ClsFailedJobsCronJobRunner(
                ntucSBLocalService,
