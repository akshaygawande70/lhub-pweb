...
public interface CommentLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Comment getCommentByEmail(long groupId, String commentEmail)
