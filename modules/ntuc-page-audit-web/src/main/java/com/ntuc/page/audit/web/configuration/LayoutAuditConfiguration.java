package com.ntuc.page.audit.web.configuration;
...
@Meta.OCD(id = "com.ntuc.page.audit.web.configuration.LayoutAuditConfiguration", localization = "content/Language", name = "layout-audit-configuration")
