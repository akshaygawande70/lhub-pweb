...
<portlet:resourceURL id="<%=MVCCommandNames.MERCHANDIZE_ORDER_RESOURCE%>"
	var="merchandizeOrderURL">
...
<section class="general-info myaccount-cxrus">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<!--Start content-->
				<div class="content active" id="#merchandize-order-history">
					<div class="box-info">
						<div class="heading-content">MERCHANDIZES</div>
						<table id="<portlet:namespace/>merchandize-list"
...
<script type="text/javascript">
	$(document).ready(function() {
		var tempTblId = "#<portlet:namespace/>merchandize-list";
		var table = $(tempTblId).DataTable({
			"sAjaxSource" : '${merchandizeOrderURL}',
			"bFilter" : false,
