...
<portlet:resourceURL
	id="<%=MVCCommandNames.EXAM_ORDER_DETAIL_RESOURCE%>"
	var="examOrderDetailURL"
>
			...
			<div class="col-md-9">
				...
				<div class="content active" id="course-order-history">
					...
					<div class="box-info" id="print-area">
						...
						<table id="<portlet:namespace/>exam-order"
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var tempTblId = "#<portlet:namespace/>exam-order";
		var table = $(tempTblId).DataTable({
			"sAjaxSource" : '${examOrderDetailURL}',
			"bFilter" : false,
