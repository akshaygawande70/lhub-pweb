...
@Component(immediate = true, property = {
		"mvc.command.name=" + web.ntuc.eshop.invoice.constants.MVCCommandNames.EXAM_ORDER_DETAIL_RENDER,
		"javax.portlet.name=" + InvoicePortletKeys.INVOICE_EXAM_PORTLET }, service = MVCRenderCommand.class)
public class InvoiceExamOrderDetailRender implements MVCRenderCommand {

	private static Log log = LogFactoryUtil.getLog(InvoiceExamOrderDetailRender.class);

	private static String detailPage = "/exam_result/exam-detail.jsp";

	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		log.info("View Exam Order Detail Render - Start");
		try {
		...
		log.info("View Exam Order Detail Render - Stop");
		return detailPage;
	}
