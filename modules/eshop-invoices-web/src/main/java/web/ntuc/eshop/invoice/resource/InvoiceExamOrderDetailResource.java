...
@Component(immediate = true, property = {
		"mvc.command.name=" + web.ntuc.eshop.invoice.constants.MVCCommandNames.EXAM_ORDER_DETAIL_RESOURCE,
		"javax.portlet.name=" + InvoicePortletKeys.INVOICE_EXAM_PORTLET }, service = MVCResourceCommand.class)
public class InvoiceExamOrderDetailResource extends BaseMVCResourceCommand {

	private Log log = LogFactoryUtil.getLog(InvoiceExamOrderDetailResource.class);

	@Override
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws Exception {
		log.info("Invoice Exam Detail Data Resource - Start");
        ...
        JSONObject result = InvoiceUtil.getExamDetailOrderHistory(
                iDisplayStart,
                iDisplayLength,
                accountId,
                defaultLocale,
