...
@Component(immediate = true, property = { 
		...
		"javax.portlet.init-param.view-template=/exam_merchandize_result/view.jsp",
		"javax.portlet.display-name=Invoice Exam Merchandize Order",
		"javax.portlet.name=" + InvoicePortletKeys.INVOICE_EXAM_MERCHANDIZE_PORTLET,
		"javax.portlet.resource-bundle=content.Language", 
		"javax.portlet.version=3.0",
		"javax.portlet.init-param.check-auth-token=false",
		"com.liferay.portlet.action-url-redirect=true",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)
public class InvoiceExamMerchandizePortlet extends MVCPortlet {
	private static Log log = LogFactoryUtil.getLog(InvoiceExamMerchandizePortlet.class);

	@Override
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
			throws IOException, PortletException {
		log.info("Invoice Exam Merchandize Result History - Start");
		try {
		...
		log.info("Invoice Exam Merchandize Result History - End");
