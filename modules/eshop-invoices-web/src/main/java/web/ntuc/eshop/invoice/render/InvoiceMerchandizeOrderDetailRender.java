...
@Component(immediate = true, property = {
		"mvc.command.name=" + web.ntuc.eshop.invoice.constants.MVCCommandNames.MERCHANDIZE_ORDER_DETAIL_RENDER,
		"javax.portlet.name=" + InvoicePortletKeys.INVOICE_MERCHANDIZE_PORTLET }, service = MVCRenderCommand.class)

public class InvoiceMerchandizeOrderDetailRender implements MVCRenderCommand {
	
	private static Log log = LogFactoryUtil.getLog(InvoiceMerchandizeOrderDetailRender.class);

	private static String detailPage = "/merchandize_result/merchandize-detail.jsp";
	
	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		log.info("View Merchandize Order Detail Render - Start");
		try {
		...
		log.info("View Merchandize Order Detail Render - Stop");
		return detailPage;
	}
