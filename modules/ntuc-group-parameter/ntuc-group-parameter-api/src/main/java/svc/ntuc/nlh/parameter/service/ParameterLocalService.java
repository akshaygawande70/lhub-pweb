...
public interface ParameterLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Parameter getByGroupCode(
		long groupId, long parameterGroupId, String paramCode, boolean deleted);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Parameter> getByGroupIdCode(
		long groupId, String paramCode, boolean deleted);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Parameter> getByParameterGroupId(
