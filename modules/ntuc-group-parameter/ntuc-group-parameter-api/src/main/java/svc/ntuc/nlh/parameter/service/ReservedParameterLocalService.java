...
/**
 * Provides the local service interface for ReservedParameter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReservedParameterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ReservedParameterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>svc.ntuc.nlh.parameter.service.impl.ReservedParameterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the reserved parameter local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ReservedParameterLocalServiceUtil} if injection and service tracking are not available.
	 */
