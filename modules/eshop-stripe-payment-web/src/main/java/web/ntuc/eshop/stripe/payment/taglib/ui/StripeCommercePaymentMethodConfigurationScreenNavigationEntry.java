...
package web.ntuc.eshop.stripe.payment.taglib.ui;
...
import web.ntuc.eshop.stripe.payment.portlet.StripeCommercePaymentMethod;
...
public class StripeCommercePaymentMethodConfigurationScreenNavigationEntry
	...
	@Reference(
		target = "(osgi.web.symbolicname=web.ntuc.eshop.stripe.payment)"
	)
