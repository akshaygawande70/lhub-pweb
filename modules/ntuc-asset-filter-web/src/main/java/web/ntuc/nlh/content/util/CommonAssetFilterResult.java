package web.ntuc.nlh.content.util;
...
public class CommonAssetFilterResult {
	private static Log log = LogFactoryUtil.getLog(CommonAssetFilterResult.class);
	private static String publishDateField = "publishDate_sortable";
	
	public static Map<String, Object> buildResultSummaryAll(List<Long> categoryIds, SearchContext searchContext,
		...
		Map<String, Object> processMap = processHitsAll(categoryIds, searchContext, themeDisplay, request, resourceRequest,
	...
	public static Map<String, Object> getHitsCountAll(List<Long> categoryIds, SearchContext searchContext,
			ThemeDisplay themeDisplay, HttpServletRequest request, ResourceRequest resourceRequest,
			ResourceResponse resourceResponse, boolean isFilter, DDMIndexer ddmIndexer, JSONObject filterJson,
			Sorts sorts, Queries queries, SearchRequestBuilderFactory searchRequestBuilderFactory,
			...
			String hitsKey, String distinctCatIdKey, String type, String eventStructureKey, String fieldArrayKey,
			String fieldNameKey, String fieldPrefixKey) throws Exception {
		Map<String, Object> mapResult = processHitsAll(categoryIds, searchContext, themeDisplay, request,
	...
	public static Map<String, Object> processHitsAll(List<Long> categoryIds, SearchContext searchContext,
			ThemeDisplay themeDisplay, HttpServletRequest request, ResourceRequest resourceRequest,
			ResourceResponse resourceResponse, boolean isFilter, DDMIndexer ddmIndexer, JSONObject filterJson,
			Sorts sorts, Queries queries, SearchRequestBuilderFactory searchRequestBuilderFactory,
			CategoryFacetFactory categoryFacetFactory, Aggregations aggregations,
...
//		Buat Main Query
		...
		if (!categoryIds.isEmpty()) {
			...
			mainQuery.addRequiredTerm(Field.ASSET_CATEGORY_IDS, 39314);
		}
