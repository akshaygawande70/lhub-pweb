...
import web.ntuc.nlh.assetfilter.dto.TopicsDto;
...
//				Getting detail data from courses id
				mapResult = CommonAssetFilterResult.buildResultSummary(categoryIds, searchContext,
						...
						searchResponseBuilderFactory, AssetFilterPortletKeys.SEARCH_RESULTS,
						AssetFilterPortletKeys.PARAMETER_ARTICLE_ADMIN_GROUP_CODE, AssetFilterPortletKeys.HITS,
						AssetFilterPortletKeys.DISTINCT_CATEGORY_IDS, "blog", null, null, null, null);

				
			}else {
				
//				Getting detail data from courses id
				 mapResult = CommonAssetFilterResult.buildResultSummaryAll(categoryIds, searchContext,
						themeDisplay, request, resourceRequest, resourceResponse, false, ddmIndexer, filterJson, sorts,
						queries, searchRequestBuilderFactory, categoryFacetFactory, aggregations,
						searchResponseBuilderFactory, AssetFilterPortletKeys.SEARCH_RESULTS,
						AssetFilterPortletKeys.PARAMETER_ARTICLE_ADMIN_GROUP_CODE, AssetFilterPortletKeys.HITS,
			...
			List<SearchResultSummaryDisplayContext> resultContent = (List<SearchResultSummaryDisplayContext>) mapResult
					.get(AssetFilterPortletKeys.SEARCH_RESULTS);
