...
import svc.ntuc.nlh.otp.model.OtpModel;

/**
 * The base model implementation for the Otp service. Represents a row in the &quot;ntuc_otp&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class OtpModelImpl extends BaseModelImpl<Otp> implements OtpModel {
	 ...
	 */
	public static final String TABLE_NAME = "ntuc_otp";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"otpCode", Types.INTEGER}, {"oTPValidatedFlag", Types.BOOLEAN}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("otpCode", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("oTPValidatedFlag", Types.BOOLEAN);
	}

	public static final String TABLE_SQL_CREATE =
		"create table ntuc_otp (uuid_ VARCHAR(75) null,otpId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,otpCode INTEGER,oTPValidatedFlag BOOLEAN)";

	public static final String TABLE_SQL_DROP = "drop table ntuc_otp";

	public static final String ORDER_BY_JPQL = " ORDER BY otp.createDate DESC";

	public static final String ORDER_BY_SQL =
		" ORDER BY ntuc_otp.createDate DESC";
	 ...
	 */
	@Deprecated
	public static final long OTPID_COLUMN_BITMASK = 4L;
	...
	static {
		...
		attributeGetterFunctions.put("uuid", Otp::getUuid);
		attributeSetterBiConsumers.put(
			"uuid", (BiConsumer<Otp, String>)Otp::setUuid);
		attributeGetterFunctions.put("otpId", Otp::getOtpId);
		attributeSetterBiConsumers.put(
			"otpId", (BiConsumer<Otp, Long>)Otp::setOtpId);
		attributeGetterFunctions.put("groupId", Otp::getGroupId);
		attributeSetterBiConsumers.put(
			"groupId", (BiConsumer<Otp, Long>)Otp::setGroupId);
		attributeGetterFunctions.put("companyId", Otp::getCompanyId);
		attributeSetterBiConsumers.put(
			"companyId", (BiConsumer<Otp, Long>)Otp::setCompanyId);
		attributeGetterFunctions.put("userId", Otp::getUserId);
		attributeSetterBiConsumers.put(
			"userId", (BiConsumer<Otp, Long>)Otp::setUserId);
		attributeGetterFunctions.put("userName", Otp::getUserName);
		attributeSetterBiConsumers.put(
			"userName", (BiConsumer<Otp, String>)Otp::setUserName);
		attributeGetterFunctions.put("createDate", Otp::getCreateDate);
		attributeSetterBiConsumers.put(
			"createDate", (BiConsumer<Otp, Date>)Otp::setCreateDate);
		attributeGetterFunctions.put("modifiedDate", Otp::getModifiedDate);
		attributeSetterBiConsumers.put(
			"modifiedDate", (BiConsumer<Otp, Date>)Otp::setModifiedDate);
		attributeGetterFunctions.put("otpCode", Otp::getOtpCode);
		attributeSetterBiConsumers.put(
			"otpCode", (BiConsumer<Otp, Integer>)Otp::setOtpCode);
		attributeGetterFunctions.put(
			"oTPValidatedFlag", Otp::getOTPValidatedFlag);
		attributeSetterBiConsumers.put(
			"oTPValidatedFlag",
			(BiConsumer<Otp, Boolean>)Otp::setOTPValidatedFlag);
	 ...
	 */
	@Deprecated
	public long getOriginalOtpId() {
		return GetterUtil.getLong(this.<Long>getColumnOriginalValue("otpId"));
	}
	...
	public Object clone() {
		...
		otpImpl.setOtpCode(getOtpCode());
		otpImpl.setOTPValidatedFlag(getOTPValidatedFlag());
	...
	public int compareTo(Otp otp) {
		...
		value = DateUtil.compareTo(getCreateDate(), otp.getCreateDate());
	...
	public CacheModel<Otp> toCacheModel() {
		...
		otpCacheModel.otpCode = getOtpCode();

		Boolean oTPValidatedFlag = getOTPValidatedFlag();

		if (oTPValidatedFlag != null) {
			otpCacheModel.oTPValidatedFlag = oTPValidatedFlag;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("oTPValidatedFlag", _oTPValidatedFlag);
	}
	...
	static {
		...
		columnBitmasks.put("otpCode", 256L);

		columnBitmasks.put("oTPValidatedFlag", 512L);
