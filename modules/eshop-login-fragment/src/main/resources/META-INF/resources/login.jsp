						...
						<div class="box-login">
							...
							<div class="login-container-custom">
								...
								<aui:form action="<%=loginURL%>"
									...
									<c:choose>
										<c:when
											...
											<div class="alert alert-success">
												<liferay-ui:message
													key="your-request-completed-successfully" />
											</div>
										</c:when>
										<c:when
									...
									<aui:fieldset>
										...
										<div class="box-input">
											...
											|| windowState.equals(WindowState.MAXIMIZED)%>"
												cssClass="clearable cs-form" label="<%=loginLabel%>" name="login"
										...
										<div class="box-input">
											<aui:input name="password" showRequiredLabel="<%=false%>" cssClass="clearable cs-form"
									...
									<span class="small">Your User ID is the email address which you have used to sign into NTUC LearningHub.</span>
									<aui:button-row>
										<!-- <aui:button type="submit" cssClass="btn-blue" value="sign-in" /> -->
										<button type="submit" class="btn-blue" ><liferay-ui:message key="sign-in" /></button>
									</aui:button-row>
								</aui:form>
...
<script type="text/javascript">
	 $("#<portlet:namespace/>loginForm div > #<portlet:namespace/>password")
			.each(
					function() {
						var b_pass = $(this);
						var act_eye = '<span class="act_show" id="eye_show"><i class="far fa-eye"></i></span>';
						var act_eye_slash = '<span class="act_hide" id="eye_hide"><i class="far fa-eye-slash"></i></span>';
