...
<liferay-ui:error exception="<%=CommerceOrderValidatorException.class%>">
	...
	%>
	<liferay-ui:message
		key="<%=commerceOrderValidatorResult.getLocalizedMessage()%>"
	/>
	<%
		}
	%>
...
<!-- <style>
.section-detail-produk .box-stick-price .btn-buy {
    padding: 0;
}
.section-detail-produk .box-stick-price .btn-buy .quantity-selector {
    display: none;
}
.section-detail-produk .box-stick-price .btn-buy .btn-add-to-cart {
    margin: 0;
    width: 100%;
    padding: 13px 20px;
...
.section-detail-produk .box-stick-price .btn-buy .btn-add-to-cart.btn.btn-primary:not([disabled]):not(.disabled)::before {
    background: transparent;
}
.section-detail-produk .box-stick-price .btn-buy .btn-add-to-cart.btn.btn-primary::after {
    content:'Buy Now'; 
    visibility: visible;
    display: block;
    position: absolute;
...
.section-detail-produk .box-stick-price .btn-buy .btn-add-to-cart .add-to-cart-icon-container {
    display: none;
}
</style> -->

<div class="section-detail-produk detail-produk-simple">
	<div class="container">
        <div class="row">
            <div class="col-12">
...
$('.detail-produk-simple .btn-add-to-cart').click(function() {
	setTimeout(function(){
