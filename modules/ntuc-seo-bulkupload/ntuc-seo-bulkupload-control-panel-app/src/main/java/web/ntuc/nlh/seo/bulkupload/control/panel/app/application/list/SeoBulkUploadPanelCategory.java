...
/**
 * @author sagar
 * The type Seo bulk upload panel category.
 */
...
public class SeoBulkUploadPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return NtucSeoBulkuploadControlPanelAppCategoryKeys.CONTROL_PANEL_CATEGORY;
	}

	@Override
	public String getLabel(Locale locale) {
		ResourceBundle resourceBundle = ResourceBundleUtil.getBundle("content.Language", locale, getClass());
		return LanguageUtil.get(resourceBundle, "NTUC SEO Admin");
	}
