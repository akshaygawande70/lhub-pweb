...
/**
 * The persistence utility for the ntuc bulk upload service. This utility wraps <code>svc.ntuc.nlh.seo.bulkupload.service.persistence.impl.NtucBulkUploadPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see NtucBulkUploadPersistence
 * @generated
 */
public class NtucBulkUploadUtil {
	 ...
	 */
	public static void clearCache(NtucBulkUpload ntucBulkUpload) {
		getPersistence().clearCache(ntucBulkUpload);
	}
	 ...
	 */
	public static Map<Serializable, NtucBulkUpload> fetchByPrimaryKeys(
	 ...
	 */
	public static List<NtucBulkUpload> findWithDynamicQuery(
	 ...
	 */
	public static NtucBulkUpload update(NtucBulkUpload ntucBulkUpload) {
		return getPersistence().update(ntucBulkUpload);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static NtucBulkUpload update(
		NtucBulkUpload ntucBulkUpload, ServiceContext serviceContext) {

		return getPersistence().update(ntucBulkUpload, serviceContext);
	}
	 ...
	 */
	public static List<NtucBulkUpload> findByUuid(String uuid) {
	 ...
	 */
	public static List<NtucBulkUpload> findByUuid(
	 ...
	 */
	public static NtucBulkUpload findByUuid_First(
			String uuid, OrderByComparator<NtucBulkUpload> orderByComparator)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {
	 ...
	 */
	public static NtucBulkUpload fetchByUuid_First(
		String uuid, OrderByComparator<NtucBulkUpload> orderByComparator) {
	 ...
	 * @throws NoSuchNtucBulkUploadException if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload findByUuid_Last(
			String uuid, OrderByComparator<NtucBulkUpload> orderByComparator)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {
	 ...
	 */
	public static NtucBulkUpload fetchByUuid_Last(
		String uuid, OrderByComparator<NtucBulkUpload> orderByComparator) {
	 ...
	 */
	public static NtucBulkUpload[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			ntucBulkUploadId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchNtucBulkUploadException if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload findByUUID_G(String uuid, long groupId)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {
	 ...
	 */
	public static NtucBulkUpload fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching ntuc bulk upload, or <code>null</code> if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload fetchByUUID_G(
	 ...
	 */
	public static NtucBulkUpload removeByUUID_G(String uuid, long groupId)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {
	 ...
	 * @return the matching ntuc bulk uploads
	 */
	public static List<NtucBulkUpload> findByUuid_C(
	 ...
	 * @throws NoSuchNtucBulkUploadException if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<NtucBulkUpload> orderByComparator)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {
	 ...
	 * @return the first matching ntuc bulk upload, or <code>null</code> if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<NtucBulkUpload> orderByComparator) {
	 ...
	 * @throws NoSuchNtucBulkUploadException if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<NtucBulkUpload> orderByComparator)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {
	 ...
	 * @return the last matching ntuc bulk upload, or <code>null</code> if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<NtucBulkUpload> orderByComparator) {
	 ...
	 * @throws NoSuchNtucBulkUploadException if a ntuc bulk upload with the primary key could not be found
	 */
	public static NtucBulkUpload[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			ntucBulkUploadId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchNtucBulkUploadException if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload findByntucBulkUploadId(long ntucBulkUploadId)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {

		return getPersistence().findByntucBulkUploadId(ntucBulkUploadId);
	}
	 ...
	 * @return the matching ntuc bulk upload, or <code>null</code> if a matching ntuc bulk upload could not be found
	 */
	public static NtucBulkUpload fetchByntucBulkUploadId(
		long ntucBulkUploadId) {

		return getPersistence().fetchByntucBulkUploadId(ntucBulkUploadId);
	}
	...
	public static NtucBulkUpload fetchByntucBulkUploadId(
		...
		return getPersistence().fetchByntucBulkUploadId(
			ntucBulkUploadId, useFinderCache);
	}
	 ...
	 * @return the ntuc bulk upload that was removed
	 */
	public static NtucBulkUpload removeByntucBulkUploadId(long ntucBulkUploadId)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {

		return getPersistence().removeByntucBulkUploadId(ntucBulkUploadId);
	}
	 ...
	 * @return the number of matching ntuc bulk uploads
	 */
	public static int countByntucBulkUploadId(long ntucBulkUploadId) {
		return getPersistence().countByntucBulkUploadId(ntucBulkUploadId);
	}
	 ...
	 */
	public static void cacheResult(NtucBulkUpload ntucBulkUpload) {
		getPersistence().cacheResult(ntucBulkUpload);
	}
	 ...
	 */
	public static void cacheResult(List<NtucBulkUpload> ntucBulkUploads) {
		getPersistence().cacheResult(ntucBulkUploads);
	}
	 ...
	 */
	public static NtucBulkUpload create(long ntucBulkUploadId) {
		return getPersistence().create(ntucBulkUploadId);
	}
	 ...
	 * @throws NoSuchNtucBulkUploadException if a ntuc bulk upload with the primary key could not be found
	 */
	public static NtucBulkUpload remove(long ntucBulkUploadId)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {

		return getPersistence().remove(ntucBulkUploadId);
	}

	public static NtucBulkUpload updateImpl(NtucBulkUpload ntucBulkUpload) {
		return getPersistence().updateImpl(ntucBulkUpload);
	}
	 ...
	 * @throws NoSuchNtucBulkUploadException if a ntuc bulk upload with the primary key could not be found
	 */
	public static NtucBulkUpload findByPrimaryKey(long ntucBulkUploadId)
		throws svc.ntuc.nlh.seo.bulkupload.exception.
			NoSuchNtucBulkUploadException {

		return getPersistence().findByPrimaryKey(ntucBulkUploadId);
	}
	 ...
	 */
	public static NtucBulkUpload fetchByPrimaryKey(long ntucBulkUploadId) {
		return getPersistence().fetchByPrimaryKey(ntucBulkUploadId);
	}
	 ...
	 */
	public static List<NtucBulkUpload> findAll() {
	 ...
	 */
	public static List<NtucBulkUpload> findAll(int start, int end) {
	...
	public static NtucBulkUploadPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<NtucBulkUploadPersistence, NtucBulkUploadPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			NtucBulkUploadPersistence.class);

		ServiceTracker<NtucBulkUploadPersistence, NtucBulkUploadPersistence>
			serviceTracker =
				new ServiceTracker
					<NtucBulkUploadPersistence, NtucBulkUploadPersistence>(
						bundle.getBundleContext(),
						NtucBulkUploadPersistence.class, null);
